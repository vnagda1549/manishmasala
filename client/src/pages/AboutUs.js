...
function AboutUs() {
    return (
        <>
            ...
            <main>
                <section>
                    {/* <img src="/images/about-banner.jpg" alt="About Us" width="100%" /> */}
                    <div className="card">
                        <h2>About Us</h2>
                    ...
                    <div className="about-details">
                        ...
                        <div className="detail-item">
                            <h3>Our Products</h3>
                            <p>At ManishMasala, we offer a wide variety of spices including:</p>
                            <ul>
                                <li>Turmeric</li>
                                <li>Cumin</li>
                                <li>Coriander</li>
                            ...
                            <p>Our spices are carefully selected to ensure the highest quality and flavor. Whether you're a professional chef or a home cook, you'll find the perfect spices to enhance your dishes.</p>
                        </div>
                    </div>
                </section>
            </main>
